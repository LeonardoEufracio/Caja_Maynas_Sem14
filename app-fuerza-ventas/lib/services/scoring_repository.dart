...
class ScoringRepository {
  ...
  Future<void> submitCreditApplication({
    ...
    final expediente =
        'CM-${now.year}${now.month.toString().padLeft(2, '0')}${now.day.toString().padLeft(2, '0')}-${now.millisecondsSinceEpoch.toString().substring(8)}';
  ...
  SalesDashboardData get _demoData {
    ...
    return SalesDashboardData(
      ...
      requests: const [
        {
          'numero_expediente': 'CM-20260526-00001',
        ...
        {
          'numero_expediente': 'CM-20260526-00002',
          'estado': 'borrador',
