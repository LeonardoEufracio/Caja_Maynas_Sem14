# Nota de proyecto Supabase correcto

Proyecto correcto para esta entrega: `https://cefsywrvzvpozkfpzrao.supabase.co`.

La `anon/public key` debe ser la de ese mismo proyecto. No se puede obtener desde la URL PostgreSQL; se copia desde Supabase > Project Settings > API.
