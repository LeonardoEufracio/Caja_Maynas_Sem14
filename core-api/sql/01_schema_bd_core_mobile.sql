-- ============================================================================
-- bd_core_mobile — Capa operacional de canales moviles (Caja Maynas)
-- ----------------------------------------------------------------------------
...
--   - App Clientes app Caja Maynas_s8 (Kotlin) -> autoservicio (consulta + solicitudes)
--
...
CREATE TABLE solicitudes_credito (
    ...
    cliente_id               UUID NOT NULL REFERENCES clientes(id),
    agencia_id               UUID REFERENCES agencias(id),
    canal                    VARCHAR(15) NOT NULL DEFAULT 'asesor'  -- asesor | cliente (app Caja Maynas)
...
-- ============================================================================
-- GRUPO 4 — APP DE CLIENTES (autoservicio app Caja Maynas_s8)
-- ============================================================================
...
-- Tarjetas de credito (la app app Caja Maynas_s8 las muestra; el core no las modela aun).
