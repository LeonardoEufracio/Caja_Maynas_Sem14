        ...
        db.execute(
            text(
                """INSERT INTO clientes
                   ...
                   VALUES
                     (:id, :cod, :doc, 'DNI', 'Jose', 'Demo Maynas',
                      '999888777', :email, 'Direccion demo Caja Maynas',
                      'Bodega', 'Bodega Demo Maynas', 3200.00,
                      'Normal', TRUE)"""
            ),
            {
                "id": cliente_id,
                ...
                "doc": numero_documento,
                "email": f"{numero_documento}@cliente.cajamaynas.pe",
            },
        )
        cliente = db.execute(
        ...
        text(
            """INSERT INTO solicitudes_credito
               ...
               SELECT :id, :exp, :asesor, :cliente_id, :agencia,
                      'cliente', 'Bodega', 'Bodega Demo Maynas', 3200.00,
    ...
    db.execute(
        text(
            """INSERT INTO cr_cuentas_ahorro
               ...
               VALUES (:id, :cod, :cliente_id, 'Ahorro Corriente', 'PEN',
        ...
        db.execute(
            text(
                """INSERT INTO cr_creditos
                   ...
                   VALUES (:id, :cod, :cliente_id, 'Microcredito Ahorita',
            ...
            text(
                """INSERT INTO cr_movimientos
                   ...
                   VALUES (:id, :codop, :cliente_id, :cuenta, 'CRE',
                           'Desembolso microcredito Ahorita', 'CORE', :monto,
                           'PEN', now())
        ...
        db.execute(
            text(
                """INSERT INTO notificaciones
                   ...
                   SELECT :id, 'cliente', :cliente_id, 'Crédito Maynas desembolsado',
