...
# App de clientes (app Caja Maynas / Flutter clientes) — login DNI + productos
app.include_router(rtr_cliente.router, prefix="/cliente", tags=["Cliente (App)"])

@app.get("/")
def root():
    return {"sistema": "Core Mobile Caja Maynas", "version": "1.0.0", "status": "ok"}
